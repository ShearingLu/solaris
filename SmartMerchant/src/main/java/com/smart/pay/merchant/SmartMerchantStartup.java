package com.smart.pay.merchant;
...
@EnableAsync
public class SmartMerchantStartup extends WebMvcConfigurerAdapter {

    private static final Logger logger = LoggerFactory.getLogger(SmartMerchantStartup.class);
    ...
    public static void main(String[] args) throws Exception {
       ...
       /* if (args.length == 0) System.getProperties().setProperty("LOG_ROOT", ".");
        ...
        SpringApplication.run(SmartMerchantStartup.class, args);
