...
@EnableAsync
public class SmartPaymentStartup  extends WebMvcConfigurerAdapter {

    private static final Logger logger = LoggerFactory.getLogger(SmartPaymentStartup.class);
    ...
    public static void main(String[] args) throws Exception {
       ...
       /* if (args.length == 0) System.getProperties().setProperty("LOG_ROOT", ".");
        ...
        SpringApplication.run(SmartPaymentStartup.class, args);
