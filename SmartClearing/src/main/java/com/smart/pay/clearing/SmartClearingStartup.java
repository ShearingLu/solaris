package com.smart.pay.clearing;
...
@EnableAsync
public class SmartClearingStartup extends WebMvcConfigurerAdapter {

    private static final Logger logger = LoggerFactory.getLogger(SmartClearingStartup.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* if (args.length == 0) System.getProperties().setProperty("LOG_ROOT", ".");
         ...
         SpringApplication.run(SmartClearingStartup.class, args);
