...
@EnableAsync
public class SmartRiskStartup extends WebMvcConfigurerAdapter {

    private static final Logger logger = LoggerFactory.getLogger(SmartRiskStartup.class);
    ...
    public static void main(String[] args) throws Exception {
       ...
       /* if (args.length == 0) System.getProperties().setProperty("LOG_ROOT", ".");
        ...
        SpringApplication.run(SmartRiskStartup.class, args);
